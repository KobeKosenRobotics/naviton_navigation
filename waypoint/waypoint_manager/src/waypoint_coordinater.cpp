...
void WaypointCoordinater::publish()
{
    ...
    absolute_pose.pose.position.x = _absolute_position.x();
    absolute_pose.pose.position.y = _absolute_position.y();
    absolute_pose.pose.position.z = _absolute_position.z();
